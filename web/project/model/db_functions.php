...
function getEmployeeById($employee_id) {
	...
	$query = 'SELECT * FROM employee
              ...
              ORDER BY employeeseniority ASC';
	$statement = $db->prepare($query);
	$statement->bindValue(':employee_id', $employee_id);
	$statement->execute();
	$employee = $statement->fetch();
 ...
 ***************************************/
function add_employee_db($first_name, $last_name, $last_four, $title, $seniority, $volunteer, $admin) {
    global $db;
    $query = 'INSERT INTO employee (employeefirstname, employeelastname, employeelastfour, employeetitle, employeeseniority, employeenumvolunteered, isadmin)
              VALUES (:first_name, :last_name, :last_four, :title, :seniority, :volunteer, :admin)';
        $statement = $db->prepare($query);
        $statement->bindValue(':first_name', $first_name);
        $statement->bindValue(':last_name', $last_name);
        $statement->bindValue(':last_four', $last_four);
 ...
 ***************************************/
function update_employee_db($employee_id, $first_name, $last_name, $last_four, $title, $seniority, $volunteer, $admin) {
    global $db;
    $query = 'UPDATE employee
    		  SET employeefirstname = :first_name,
    		      employeelastname = :last_name,
                  employeelastfour = :last_four,
    		      employeetitle = :title,
        ...
        $statement->bindValue(':last_four', $last_four, PDO::PARAM_INT);

    ...
    <?php 
      ...
      <form method="post" action=".">
        ...
        <fieldset>
            ...
            <input id="lfour" type="text" name="lfour" value="<?php echo $employee['employeelastfour']; ?>"><br>
            ...
            <input type="text" name="admin" value="<?php echo $admin; ?>"><br>

            <input type="hidden" name="employeeid" value="<?php echo $employee['employeeid']; ?>"><br><br>
            <a href=".?action=view_all_employees"><button class="delete_btn">Cancel</button></a>

            <input class="submit_btn" type="submit" value="Update Employee">
        </fieldset>
      </form>

  ...
  <div id="nav">
	...
	<div  class="confirm">
		<p>
			<?php 
				if ($button === "confirm") {
					echo '<span id="confirmpar"><h2>Payment Confirmation</h2>' . $fullName . 
          ', thank you for trusting Tough Storage.<br/><br/> Your payment for $' 
          . $unitTotal . '  has been confirmed.<br/><br/> A confirmation email 
	...
	<div class="confirm">
		<p>
			<?php 
				if ($button === "cancel") {
					echo '<span id="cancelpar"><h2>Your Payment Has Been Canceled</h2>' . $fullName . 
          ', your payment for $' . $unitTotal . ' has been cancel.<br/><br/> Your 
          credit card has <u>not</u> been charged.<br/><br/> Please keep Tough Storage 
